...
inline void cgal_pointcloud_boolean_difference(CGAL::Point_set_3<Point_3>& cgal_cloud_0, CGAL::Point_set_3<Point_3>& cgal_cloud_1, CGAL::Point_set_3<Point_3>& cgal_cloud_result, double radius = 2)
{
