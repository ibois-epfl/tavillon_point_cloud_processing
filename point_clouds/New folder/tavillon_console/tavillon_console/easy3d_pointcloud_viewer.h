...
inline void viewer_display_polylines(easy3d::Viewer& viewer, std::vector<std::vector<Point_3>>& polylines, int display_specific_id = -1) {//, std::vector<std::vector<IK::Point_3>>& polylines
...
inline void viewer_display_polylines_tree(easy3d::Viewer& viewer, std::vector<std::vector<std::vector<Point_3>>>& polylines_tree, int display_specific_id = -1) {//, std::vector<std::vector<IK::Point_3>>& polylines
...
inline void viewer_display_point_cloud(easy3d::Viewer& viewer, CGAL::Point_set_3<Point_3>& cgal_cloud, float r = 0, float g = 0, float b = 0, float weight = 5) {
