// TavillonPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"Tavillon");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"6B79B4F8-CFF6-49B4-B4A6-F6B02D299F64");
...
RHINO_PLUG_IN_DESCRIPTION(L"Tavillon plug-in for Rhinoceros®");
...
// The one and only CTavillonPlugIn object
static class CTavillonPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// CTavillonPlugIn definition

CTavillonPlugIn& TavillonPlugIn()
{
	// Return a reference to the one and only CTavillonPlugIn object
	return thePlugIn;
}

CTavillonPlugIn::CTavillonPlugIn()
{
	// Description:
	//   CTavillonPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, CTavillonPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* CTavillonPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* CTavillonPlugIn::PlugInVersion() const
{
	// Description:
...
GUID CTavillonPlugIn::PlugInID() const
{
	// Description:
	...
	// {6B79B4F8-CFF6-49B4-B4A6-F6B02D299F64}
...
BOOL CTavillonPlugIn::OnLoadPlugIn()
{
	// Description:
...
void CTavillonPlugIn::OnUnloadPlugIn()
{
	// Description:
