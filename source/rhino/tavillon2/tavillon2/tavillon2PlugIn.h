// tavillon2PlugIn.h : main header file for the tavillon2 plug-in.
//

#pragma once

// Ctavillon2PlugIn
// See tavillon2PlugIn.cpp for the implementation of this class
//

class Ctavillon2PlugIn : public CRhinoUtilityPlugIn
{
public:
  ...
  // Ctavillon2PlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, Ctavillon2PlugIn::OnUnloadPlugin() is called. Do
  // not do too much here. Be sure to clean up any memory you have allocated
  // with onmalloc(), onrealloc(), oncalloc(), or onstrdup().
  ~Ctavillon2PlugIn() = default;
