// tavillon_rhinoPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"tavillon_rhino");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"645B0296-07E6-42B2-AFEB-13EBF45E81B0");
...
RHINO_PLUG_IN_DESCRIPTION(L"tavillon_rhino plug-in for Rhinoceros®");
...
// The one and only Ctavillon_rhinoPlugIn object
static class Ctavillon_rhinoPlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// Ctavillon_rhinoPlugIn definition

Ctavillon_rhinoPlugIn& tavillon_rhinoPlugIn()
{
	// Return a reference to the one and only Ctavillon_rhinoPlugIn object
	return thePlugIn;
}

Ctavillon_rhinoPlugIn::Ctavillon_rhinoPlugIn()
{
	// Description:
	//   Ctavillon_rhinoPlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, Ctavillon_rhinoPlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* Ctavillon_rhinoPlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* Ctavillon_rhinoPlugIn::PlugInVersion() const
{
	// Description:
...
GUID Ctavillon_rhinoPlugIn::PlugInID() const
{
	// Description:
	...
	// {645B0296-07E6-42B2-AFEB-13EBF45E81B0}
...
BOOL Ctavillon_rhinoPlugIn::OnLoadPlugIn()
{
	// Description:
...
void Ctavillon_rhinoPlugIn::OnUnloadPlugIn()
{
	// Description:
